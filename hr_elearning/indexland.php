...
<head>
  ...
  <meta charset="UTF-8">
  <title>Daily UI #003: Landing page</title>
...
<div class="landing">
  <div class="base">
    ...
    <div class="copy">
      ...
      <div class="title">
        <small>Halcyon Marine </small> Healthcare Systems</div>
 
        <div class="text" >

        "The Gold Standard in Maritime Healthcare"

   <img src="img/halcyony.png" style="position:absolute;left:60%;width:300px;height: 300px;">
</div>
  <div class="allright"> 
   <form method="post" action="indexland.php">
...
$quantum=mysqli_query($connhalcyon,"SELECT * FROM cor_progress WHERE userId='".$box."'");
...
mysqli_query($connhalcyon,"INSERT INTO cor_progress(`userId`,`status`,`courseId`,`coursename`) VALUES ('".$box."','Pending','".$physics1['courseid']."','".$physics1['coursename']."')");
