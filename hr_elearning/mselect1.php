...
<button  name="view" value="View"   id="<?php echo $row["id"]; ?>"  class="btn btn-info btn-xs view_edit" data-toggle="modal" data-target="#edataModal2"> 
      ...
      <div class="modal-dialog" role="document">  
           <div class="modal-content">  
                ...
                <div class="modal-footer">  
                     ...
                     <button type="submit" class="btn btn-info" name="vidadd" >Add</button>    
                     <button type="button" class="btn btn-info" data-dismiss="modal">Close</button>  
                </div>  
           </div>  
      </div>  
