...
<div id ="cardo" class="card-overlay">
    ...
    <div class="text-center">
        <div class="card-block">
            ...
            <a class="btn btn-info" href="aecourse.php"><i class="fa fa-clone left"></i> View Course</a>
        </div>
    </div>
</div>
<!--/.Card-->
...
<div id ="cardo" class="card-overlay">
    ...
    <div class="text-center">
        <div class="card-block">
            <h1><i class="fa fa-desktop" style="font-size: 210px;"></i></h1>
            <h3>Module</h3>

            <a class="btn btn-info" href="aemodule.php"><i class="fa fa-clone left"></i> View Module</a>
        </div>
    </div>
</div>
<!--/.Card-->
