...
$_FILES['imagebg']['name'] = $vidId.$filetype1;
        ...
        $local_image = 'img/';
        move_uploaded_file($tmp_name1,$local_image.$filename1);
        $imageto = "img/".$_FILES['imagebg']['name'];
...

{
    ...
    $courseid = $_POST["getpos"];
            ...
            $table2 = "select * from fposition WHERE id='$jobid'";
            $run_query2b = mysqli_query($dbcon,$table2);
...
<nav>
  ...
  <nav role="navigation">
    <ul>
      <li><a href="home.php" data-content="Manage Courses & Modules"><i class="fa fa-cogs"></i><br>Maintenance</a></li>
      ...
      <li><a href="#" data-content="Logout Now"><i class="fa fa-sign-out"></i><br>Logout</a></li>
    </ul>
  </nav>
</div>
...
<div class="row">
   ...
   <div class="selectholder" style="width:100%;">
    ...
    <select name="country" id="country-list" class="form-control selectpicker">
     <option alt="0" value="0">Job Positions ...</option>


       <?php
       $x='aw';
       $x1=1;
        echo '<option  value="'.$x.'">Job Positions ...</option>';
        echo '<option  value="'.$x.'">Job Positions ...</option>';
        echo '<option  value="'.$x.'">Job Positions ...</option>';
        echo '<option  value="'.$x.'">Job Positions ...</option>';
        echo '<option  value="'.$x.'">Job Positions ...</option>';
        ...
        echo "<option value='$row[positionname]' ></option>";
        }
        ?>
...
<form role="form" method="post" action="ecourse.php" enctype="multipart/form-data">
                   <fieldset>
...
<br>
<h4>Description</h4>
<textarea rows="7" cols="50" name="cdetails1"></textarea>
<h4>Add Image</h4>
...
<div class="row col-md-12">
  <input type="radio" name="color" value="rgba(3, 169, 244, 0.7)">&nbsp;<img src="color/bluestrong.png" class="img-fluid" style="height:70px; width:200px;" required> &nbsp;
  <input type="radio" name="color" value="rgba(244, 67, 54, 0.7)">&nbsp;<img src="color/cyanstrong.png" class="img-fluid" style="height:70px; width:200px;" required> &nbsp;
  <input type="radio" name="color" value="rgba(233, 30, 99, 0.7)">&nbsp;<img src="color/greenstrong.png" class="img-fluid" style="height:70px; width:200px;" required> &nbsp;
</div>
</center>  
<center>
<br>
<div class="row col-md-12">
  <input type="radio" name="color" value="rgba(156, 39, 176, 0.7)">&nbsp;<img src="color/indigostrong.png" class="img-fluid" style="height:70px; width:200px;" required> &nbsp;
  <input type="radio" name="color" value="rgba(63, 81, 181, 0.7)">&nbsp;<img src="color/limestrong.png" class="img-fluid" style="height:70px; width:200px;" required> &nbsp;
  <input type="radio" name="color" value="rgba(0, 188, 212, 0.7)">&nbsp;<img src="color/orangestrong.png" class="img-fluid" style="height:70px; width:200px;" required> &nbsp;
</div>
</center>  
<center>
<br>
<div class="row col-md-12">
  <input type="radio" name="color" value="rgba(0, 150, 136, 0.7)">&nbsp;<img src="color/pinkstrong.png" class="img-fluid" style="height:70px; width:200px;" required> &nbsp;
  <input type="radio" name="color" value="rgba(76, 175, 80, 0.7)">&nbsp;<img src="color/redstrong.png" class="img-fluid" style="height:70px; width:200px;" required> &nbsp;
  <input type="radio" name="color" value="rgba(205, 220, 57, 0.7)">&nbsp;<img src="color/strongpurple.png" class="img-fluid" style="height:70px; width:200px;" required> &nbsp;
</div>
</center>  
<center>
<br>
<div class="row col-md-12">
  <input type="radio" name="color" value="rgba(255, 235, 59, 0.7)">&nbsp;<img src="color/tealstrong.png" class="img-fluid" style="height:70px; width:200px;" required> &nbsp;
  <input type="radio" name="color" value="rgba(255, 152, 0, 0.7)">&nbsp;<img src="color/yellowstrong.png" class="img-fluid" style="height:70px; width:200px;" required> &nbsp;
